...
def upload():
    ...
    try:
        ...
        return render_template('index4.html', media_urls=media_urls)  # Pass URLs to template

    except Exception as e:
        return render_template('index4.html', error=f'Failed to load JSON: {str(e)}', media_urls=[]) # Return an empty list if failed
